    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow sm:rounded-lg">
                <form action="{{ route('diet-plans.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-blue-800">Auto-Generation</h3>
                                <div class="mt-2 text-sm text-blue-700">
                                    <p>Days will be automatically generated between the start and end dates. You can add meals to each day after creating the plan.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="{{ route('diet-plans.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                            Cancel
                        </a>
